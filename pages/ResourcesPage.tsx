                ...
                <section className="mt-16">
                    ...
                    <div className="max-w-3xl mx-auto rounded-lg shadow-lg p-8">
                        <div className="flex justify-center border-b border-gray-700">
                            ...
                            <button onClick={() => setActiveTab('seniors')} className={`px-6 py-3 font-semibold ${activeTab === 'seniors' ? 'text-brand-red border-b-2 border-brand-red' : 'text-gray-400'}`}>For Seniors</button>
                        </div>
                        <div className="pt-6">
                        ...
                        {[1, 2, 3].map(i => (
                            <div key={i} className="rounded-lg shadow-lg overflow-hidden">
                                ...
                                <div className="p-6">
                                    ...
                                    <p className="text-gray-400 mt-2 text-sm">A short video demonstrating a crucial self-defense maneuver.</p>
                                </div>
                            </div>
                        ))}
                    </div>
