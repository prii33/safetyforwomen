...
Today’s young people deserve better preparation. They need to know that their bodies are inviolable, that unwanted touch is never acceptable, and that their voice is their power. We must teach assertiveness not as an optional social skill but as a fundamental tool for personal safety.

**What helps:**

- Workshops in schools and colleges on responding to harassment.
- Open family conversations about bodily autonomy and consent.
- Clear reporting mechanisms and zero-tolerance policies on public transport.
- Adults modeling intervention when we witness harassment—showing what support looks like.
